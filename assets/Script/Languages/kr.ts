export const KR = {
    ...
    InputBufferTypeStockpile: "비축",
    InputBuffer: "입력 자원 완충",
    InputBufferDesc:
        "이 건물의 생산을 위해 운송받고 저장할 최대 자원. 자동은 지속적인 생산을 가능하게 하는 최소한을 유지하는 것을 의미합니다. 비축이란 저장고의 양에 상관없이 항상 입력 자원을 받는 것을 의미합니다.",
    InputCapacityOverride: "입력 용량 재정의",
    InputCapacityOverrideDesc: "각 생산 주기마다 생산에 필요한 자원의 %{percent}를 운송합니다",
    PumpkinSpiceLatte: "펌킨 스파이스 라떼",
    PumpkinPie: "호박 파이",
    QuantumComputerLab: "양자 컴퓨터 연구소",
    QuantumComputer: "양자 컴퓨터",
    TVStudioPlus: "TV 스튜디오+",
    ...
    OpenSource: "기여",
    OpenSourceDesc: "Industry Idle는 이제 오픈소스 입니다. Github에서 개발에 기여 해주세요",
    GameGuides: "게임 가이드",
    GameSetting: "설정",
    GameSettingDesc: "Configure the game to best suit you.",
    GameSettingGeneral: "일반",
    GameSettingDisplay: "디스플레이",
    GameSettingHideElements: "Hide From View",
    GameSettingAudio: "오디오",
    GameSettingGameplay: "게임플레이",
    GameSettingSinglePlayerMode: "싱글 플레이 모드",
    ...
    GameSettingVolumeControl: "볼륨 조절",
    GameSettingMusicVolume: "음악 볼륨",
    GameSettingMusicVolumeDesc: "배경음악 볼륨 조절.",
    GameSettingSFXVolume: "효과음 볼륨",
    GameSettingSFXVolumeOverride: "효과음 세부 설정",
    GameSettingSFXVolumeDesc: "Controls the volume the sound effects are played at.",
    GameSettingSFXEnableOverride: "효과음 세부 설정 활성",
    GameSettingSFXClick: "클릭",
